...
export class FormBuilderComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        this.optionLabels = [
            ...
            { name: "Penurunan BB Selama 1 Bulan Terakhir (Berdasarkan Penilaian Obyektif  Bila Adaa/ Penilaian Subyektif dari Orang Tu8a Pasien atau untuki Bayi Kurang dari 1 tahun, BB Tidak Naik Selama 3 Bulan Terakhir" },
            { namw: "Apakah Terdapat Kondisi Salah satu Diare Lebih dari 5x per Hari, Muntah Lebih Dari 3x Per Hari & Asupan Makan Berkurang Selama 1 Minggu Terakhir " },
            { namw: "Adakah Penyakit Atau Keadaan Yang Mengakibatkan Pasien Beresiko Mengalami Malnutrisi " },
            { namw: "Total Skor " },
            { namw: "Risiko Nutrisi " },
            { namw: "Score Frekuensi Napas 30'-60' " },
            { namw: "Score Frekuensi Napas Extra " },
            { namw: "Score Retraksi 30'-60' " },
            { namw: "Score Retraksi Napas Extra " },
            { namw: "Score Sianosis 30'-60' " },
            { namw: "Score Sianosis Napas Extra " },
            { namw: "Score Air Entry 30'-60' " },
            { namw: "Score Air Entry Napas Extra " },
            { namw: "Score Merintih 30'-60' " },
            { namw: "Score Merintih Napas Extra " },
        ]
    }
